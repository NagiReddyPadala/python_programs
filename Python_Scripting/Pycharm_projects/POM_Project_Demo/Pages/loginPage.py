from POM_Project_Demo.Locators.locators import Locator
class LoginPage():
    def __init__(self, driver):
        ...
        self.invalidUsername_message_id = Locator.invalidUsername_message_id
    ...
    def check_invalid_username_message(self):
        return self.driver.find_element_by_id(self.invalidUsername_message_id).text
